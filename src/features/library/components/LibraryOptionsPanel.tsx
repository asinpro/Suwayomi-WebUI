...
export const LibraryOptionsPanel = ({
    ...
    category: any; // CategoryMetadataInfo type removed
    open: boolean;
    onClose: () => void;
}) => {
    ...
    // Category feature is deleted, so these are stubbed
    // Stub categoryLibraryOptions to prevent undefined errors
    const categoryLibraryOptions = {
        hasUnreadChapters: false,
        hasReadChapters: false,
        hasDownloadedChapters: false,
        hasBookmarkedChapters: false,
        hasDuplicateChapters: false,
        hasStatus: Object.fromEntries(Object.values(MangaStatus).map((status) => [status, false])),
        sortBy: 'unreadChapters', // default LibrarySortMode
        sortDesc: false,
    };
    const updateCategoryLibraryOptions = () => {};
                    ...
                    return (
                        <>
                            <ThreeStateCheckboxInput
                                ...
                                onChange={() => updateCategoryLibraryOptions()}
                            />
                            <ThreeStateCheckboxInput
                            ...
                            {/* Tracker feature removed: tracked filter omitted */}
                        </>
                    );
                }
                if (key === 'sort') {
                    return SORT_OPTIONS.map(([mode, label]) => (
                        <SortRadioInput
                            ...
                            onClick={() => updateCategoryLibraryOptions()}
                        />
                    ));
                }
                if (key === 'display') {
